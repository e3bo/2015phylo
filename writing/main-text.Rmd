...
A recent porcine epidemic diarrhea virus (PEDV) outbreak provides a
fine example of a situation in which phylogeographic methods could be
useful.  PEDV emerged in the United States in 2013, rapidly spread
throughout much of the country, and was later detected in neighboring
Canada and Mexico [@hill2014;@efsa2014]. A U.S. strain has been
confirmed to cause severe watery diarrhea and vomiting
[@jung_pathology_2014], characteristic symptoms of porcine epidemic
diarrhea (PED). Morbidity during a PED outbreak can be extremely high,
and more than 90 percent of unweaned pigs may die
[@stevenson2013]. Those pigs that do survive have been found to be
less productive [@alvarez2015].
...
<!---
 This paragraph explains how phylogeographic approaches can be used to
 answer questions about PEDV and reviews existing methods
--->
...
Therefore, a natural way of answering the above questions about PEDV
is to employ the growing number of phylogeographic methods such as in
references [@nelson2011;@lemey2014;@magee2014;@nelson2015].
...
Although several papers have pioneered the area of regression modeling
of migration rates, many questions about this approach remain.
...
Here, we introduce a new approach to identification of phylogeographic
models, provide and example of its application on PEDV data, and
evaluate the performance of the method with simulation.
...
farm-to-farm spread [@lowe2014;@thomas2015].



We use simulation to verify our ability to accurately estimate
parameters for our assumed model. Regarding the nature of PEDV's
introduction to the United States, we look for evidence of multiple
introductions by comparing estimated ages of common ancestors of two
clades with the first known outbreak of PEDV in the United States.
...
prediction the rates of state-to-state movement of PEDV.
