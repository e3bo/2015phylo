...
diarrhea and vomiting~\cite{jung_pathology_2014}, and more than 90 percent of
unweaned pigs may die during an outbreak on a
farm~\cite{stevenson2013}. Pigs surviving infection have been found to
be less productive~\cite{alvarez2015}.
